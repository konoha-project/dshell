...
public class SubstitutionTokenFunc extends ZTokenFunction {
	@Override
	...
	private boolean Tokenize(ZSourceContext SourceContext, int StartIndex, char EndChar) {
		...
		ZToken Token = new SubstitutionToken(SourceContext, StartIndex, EndIndex);
		((SubstitutionToken)Token).SetNode(Node);
